        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('activities.update', $activity->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('topic')) has-error @endif">
                  ...
                  <input type="text" id="topic-field" name="topic" class="form-control" value="{{ $activity->topic }}"/>
                  @if($errors->has("topic"))
                ...
                <div class="form-group @if($errors->has('time')) has-error @endif">
                  ...
                  <input type="text" id="time-field" name="time" class="form-control" value="{{ $activity->time }}}"/>
                  @if($errors->has("time"))
                ...
                <div class="form-group @if($errors->has('location')) has-error @endif">
                  ...
                  <input type="text" id="location-field" name="location" class="form-control" value="{{ $activity->location }}"/>
